...
async def register_with_eureka():
    try:
        ...
        app_name = os.getenv('APP_NAME', 'service-vm-offer')
        ...
        await eureka_client.init_async(
            ...
            metadata={
                ...
                "securePort": "443",
                "statusPageUrl": f"http://{app_host}:{app_port}/api/service-vm-offer/info",
                "healthCheckUrl": f"http://{app_host}:{app_port}/api/service-vm-offer/health"
            }
        )
