...
sudo mkdir -p /opt/firecracker/logs
sudo mkdir -p /opt/firecracker/vm
...
sudo cp "../docs/os/ubuntu-24.04.squashfs.upstream" "/opt/firecracker/rootfs/"
sudo cp "../docs/os/vmlinux-5.10.225" "/opt/firecracker"
